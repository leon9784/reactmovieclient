...
class App extends Component {
  ...
  getAllMovies = () => {
    axios
      .get('https://gentle-savannah-72880.herokuapp.com/getallmovies')
      .then(result => {
  ...
  onSubmit = e => {
    ...
    const query = `https://gentle-savannah-72880.herokuapp.com/getmovie?title=${
      this.state.title
    }`;
  ...
  removeMovie(title) {
    ...
    const query = `https://gentle-savannah-72880.herokuapp.com/deletemovie?title=${title}`;
    axios
      .get(query)
      .then(result => {
        this.getAllMovies();
